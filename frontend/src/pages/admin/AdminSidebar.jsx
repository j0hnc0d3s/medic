...
const NAV_ITEMS = [
  ...
  { key: 'patients',      label: 'Patients',       path: '/admin/patients',     icon: 'patient' },
  { key: 'messages',      label: 'Messages',       path: '/admin/messages',     icon: 'send' },
  { key: 'finances',      label: 'Finance',       path: '/admin/finances',     icon: 'finance' },
]
...
const ICONS = {
  ...
  patient: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="8" r="3" stroke="currentColor" strokeWidth="1.6"/><path d="M5 20a7 7 0 0114 0" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg>,
  finance: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 3v18M16 7.5c0-1.7-1.8-3-4-3s-4 1.3-4 3 1.8 3 4 3 4 1.3 4 3-1.8 3-4 3-4-1.3-4-3" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>,
}
