...
// Admin doesn't operate the clinical-workflow pages day-to-day —
// same shorter set as AdminSidebar.jsx.
...
export default function NurseMessaging() {
  ...
  const NAV_ITEMS = isAdmin ? ADMIN_NAV_ITEMS : STAFF_NAV_ITEMS
      ...
      <div className="ns-shell">
        ...
        <div className="ns-nav">
          ...
          <div className="ns-nav-footer">
            <button className="ns-icon-btn" onClick={() => navigate(isAdmin ? '/admin/settings' : '/staff/settings')} aria-label="Settings">
