...
const Register = () => {
  ...
  const handleLogin = async (e) => {
    ...
    // After successful register, redirect based on user role:
    // - Admin → Admin Dashboard
    // - Staff (Doctor/Nurse/Receptionist) → Staff Dashboard
    // - Patient → Patient Dashboard
    console.log('Register attempt:', { email, password });
  };

  const handleSocialRegister = (provider) => {
    // TODO: Implement social auth (Google, Apple, Facebook)
        ...
        <div className="register-card">
          ...
          <div className="medic-logo">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
              <path d="M24 8L24 40M8 24L40 24M16 16L32 32M32 16L16 32" stroke="#000" strokeWidth="3" strokeLinecap="round"/>
            </svg>
          </div>
