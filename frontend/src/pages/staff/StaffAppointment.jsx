// ─────────────────────────────────────────────────────────
// FILE : src/pages/staff/StaffAppointment.jsx
...
export default function StaffAppointment() {
  ...
  const [formData, setFormData] = useState({
    patientName: '', doctor: '', patientPhone: '',
    appointmentDate: '', appointmentTime: '', duration: '',
    reason: '', type: '', priority: 'Medium',
    patientNotes: '', specialistNotes: '',
  })
        ...
        <div className="appt-form-page">
          ...
          <div className="appt-form-actions">
            <button className="appt-form-cancel"
              onClick={() => navigate('/staff/appointments')}>Cancel</button>
